        ...
        if(!isset($error)){
            try{
                ...
                $sql = "INSERT INTO users (firstname, lastname, username, email, password, comments, validationcode, active, joined, last_login) 
                        VALUES (:firstname, :lastname, :username, :email, :password, :comments, :vcode, 0, current_date, current_date)"; 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="register-form" method="post" role="form" >
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email_confirm" id="email_confirm" tabindex="4" class="form-control" placeholder="Email Confirm" value="<?php echo $email_conf ?>" required >
                                        </div>
                                        <div class="form-group">
