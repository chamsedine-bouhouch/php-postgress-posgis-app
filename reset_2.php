    ...
    if($_GET['user']){
        if($_GET['code']){
            ...
            if(count_field_val($pdo, "users","username", $username)>0){
                ...
                set_msg("No code included with reset request");
                redirect("index.php");
            }
            }
            // redirect("index.php");
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="register-form" method="post" role="form" >
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password_confirm" id="password_confirm" tabindex="6" class="form-control" placeholder="Confirm Password" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
